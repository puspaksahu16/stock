    ...
    <div class="d-flex flex-grow-1">
        <ul class="navbar-nav flex-row align-items-center ml-auto">
            ...
            {{--<li class="nav-item dropdown notification">--}}
                ...
                {{--<div class="dropdown-menu dropdown-menu-right">--}}
                    ...
                    {{--<div class="notification-list">--}}
                        {{--<div class="media new">--}}
                            {{--<div class="img-user"><img src="{{ asset('admin/assets/dist/img/avatar.png') }}" alt=""></div>--}}
                        ...
                        {{--</div><!--/.media -->--}}
                        {{--<div class="media new">--}}
                            {{--<div class="img-user online"><img src="{{asset('admin/assets/dist/img/avatar2.png')}}" alt=""></div>--}}
                            {{--<div class="media-body">--}}
                        ...
                        {{--</div><!--/.media -->--}}
                        {{--<div class="media">--}}
                            {{--<div class="img-user"><img src="{{ asset('admin/assets/dist/img/avatar3.png') }}" alt=""></div>--}}
                            {{--<div class="media-body">--}}
                        ...
                        {{--</div><!--/.media -->--}}
                        {{--<div class="media">--}}
                            {{--<div class="img-user"><img src="{{ asset('admin/assets/dist/img/avatar4.png') }}" alt=""></div>--}}
                            {{--<div class="media-body">--}}
            ...
            {{--<li class="nav-item dropdown user-menu">--}}
                ...
                {{--<div class="dropdown-menu dropdown-menu-right" >--}}
                    ...
                    {{--<div class="user-header">--}}
                        ...
                        {{--</div><!-- img-user -->--}}
                        {{--<h6>Naeem Khan</h6>--}}
                        {{--<span><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="91f4e9f0fce1fdf4d1f6fcf0f8fdbff2fefc">[email&#160;protected]</a></span>--}}
                    {{--</div><!-- user-header -->--}}
            ...
            {{--</li>--}}
                ...
                @if (Auth::guest())
                    <li><a href="{{ route('login') }}" class="dropdown-item" > <i class="typcn typcn-lock-closed-outline"></i>Login</a></li>
